...
var _user$project$Main$UpdateMonth = function (a) {
	return {ctor: 'UpdateMonth', _0: a};
};
var _user$project$Main$UpdateDay = function (a) {
	return {ctor: 'UpdateDay', _0: a};
};
var _user$project$Main$UpdateXP = function (a) {
	return {ctor: 'UpdateXP', _0: a};
};
var _user$project$Main$inputBoxes = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('XP'),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateXP)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Day'),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateDay)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Month'),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateMonth)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Year'),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$UpdateYear)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('When will I reach the next level?')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Enter your numbers!')
					])),
				_user$project$Main$inputBoxes(model),
				A2(
				_elm_lang$html$Html$h3,
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Here are your results:')
					])),
				_user$project$Main$results(model)
			]));
};
